                    ...
                    <form ref={projectFormRef} onSubmit={onSubmit} autoComplete="off" className="newpost-form">
                        ...
                        <div className="regular-input-section">
                            ...
                            <div className="form-item">
                                ...
                                <input value={encoder} onChange={onChange} name="encoder" id="project-encoder" type="text" placeholder="Insira o nome do encoder do projeto." className="form-input" required />
                            </div>
                            <div className="form-item">
